HMU.World.Emitter = function(options) {
	options = options || {};
...
HMU.World.Emitter.prototype = Object.create(THREE.Object3D.prototype);

HMU.World.Emitter.prototype.reset = function() {
...
HMU.World.Emitter.prototype.tick = function(delta) {
...
HMU.Option.prototype.get = function() {
	if(this.type === 'Vector3') {
		return HMU.Random.vector3(this.base, this.spread);
	}
	if(this.type === 'Euler') {
		return HMU.Random.euler(this.base, this.spread);
	}
	if(this.type === 'Color') {
		return HMU.Random.color(this.base, this.spread);
	}
	else if(this.type === 'Number') {
		return HMU.Random.float(this.base, this.spread);
	}
	else {
		throw new Error('Unknown type ' + this.type);
	}
