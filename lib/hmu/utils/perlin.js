...
// This is a port of Ken Perlin's Java code. The original Java code is at http://cs.nyu.edu/~perlin/sample/
HMU.PerlinNoise = (function() {
	...
	PerlinNoise.prototype.sample3 = function(x, y, z, m) {
		if(m) {
	...
	PerlinNoise.prototype.sample3tess = function(x,y,z, a,b, n,m) {
		var sum = 0;
		
		var scale = 1;
		for(var i = 0; i < n; i++) {
			sum += this.sample3(x, y, z, m) / scale;
